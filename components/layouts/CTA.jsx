      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col-reverse lg:flex-row items-center justify-between gap-16">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <Link href="/contact">
              <Button className="cursor-pointer bg-emerald-600 text-white px-6 py-6 rounded-full text-sm font-medium shadow hover:bg-emerald-700 transition">
                Donate Now
              </Button>
            </Link>
            <Link href="/contact">
              <Button className="cursor-pointer border border-blue-900 bg-white text-blue-900 px-6 py-6 rounded-full text-sm font-medium hover:bg-blue-100 transition">
                Become a Volunteer
              </Button>
            </Link>
          </div>
